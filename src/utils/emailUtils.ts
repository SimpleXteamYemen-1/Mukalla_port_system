...
يسعدنا إبلاغك بأنه قد تمت الموافقة رسمياً على حسابك في نظام إدارة ميناء المكلا.
...
نظام إدارة ميناء المكلا

--------------------------------------------------

Dear ${name},

We are pleased to inform you that your account for the Seaport Management System has been officially approved. 
...
لقد تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بحسابك في نظام إدارة ميناء المكلا.
...
We received a request to reset your password for the Seaport Management System.
